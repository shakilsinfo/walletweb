(function (e) {
    ...
    var l = e.fn.dataTable,
        j = function (c, b) {
            ...
            this.c = e.extend(!0, {}, l.defaults.rowReorder, j.defaults, b);
            this.s = {
                bodyTop: null,
                dt: new l.Api(c),
    ...
    e.extend(j.prototype, {
        ...
        _mouseMove: function (c) {
            ...
            if (null === this.s.lastInsert || this.s.lastInsert !== d)
                0 === d ? this.dom.target.prependTo(k) : ((b = e.unique(h.rows({ page: "current" }).nodes().toArray())), d > this.s.lastInsert ? this.dom.target.insertAfter(b[d - 1]) : this.dom.target.insertBefore(b[d])),
                    this._cachePositions(),
                    (this.s.lastInsert = d);
            this._shiftScroll(c);
        },
        _mouseUp: function () {
            ...
            k = [j, { dataSrc: h, nodes: l, values: f, triggerRow: b.row(this.dom.target) }];
            this._emitEvent("row-reorder", k);
            this.c.editor &&
                ((this.c.enabled = !1),
                this.c.editor
                    .edit(l, !1, e.extend({ submit: "changed" }, this.c.formOptions))
                    .multiSet(h, f)
